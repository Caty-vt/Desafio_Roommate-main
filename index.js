...
http
    .createServer(function (req, res) {
        let gastosJSON = JSON.parse(fs.readFileSync("file/gastos.json", "utf8"));
        let arregloGastos = gastosJSON.gastos;

        let usuariosJSON = JSON.parse(fs.readFileSync("file/roommates.json", "utf8"));
        ...
        // LISTAR TODOS LOS USUARIOS DEL JSON.
            ...
            try {
                ...
                res.statusCode = 200;
                res.end(fs.readFileSync("file/roommates.json", "utf8"));
            } catch (error) {
        ...
        // LISTAR TODOS LOS GASTOS DEL JSON.
            ...
            try {
                res.setHeader("Content-Type", "application/json");
                res.statusCode = 200;
                res.end(fs.readFileSync("file/gastos.json", "utf8"));
            } catch (error) {
            ...
            req.on("end", () => {
                try {
                    if (body == undefined) {
                        ...
                        fs.writeFileSync("file/gastos.json", JSON.stringify(gastosJSON, null, 4));
                        ...
                        // enviarCorreo(nombre, descripcion, monto,)
                        //     .then((result) => {
